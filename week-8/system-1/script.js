...
blob1.style.width = Math.random() * 400 + 100 + "px";
blob1.style.height = Math.random() * 400 + 100 + "px";

blob2.style.width = Math.random() * 400 + 100 + "px";
blob2.style.height = Math.random() * 400 + 100 + "px";


blob3.style.width = Math.random() * 200 + 100 + "px";
blob3.style.height = Math.random() * 400 + 100 + "px";

blob1.style.left = Math.random() * 50 + 1 + "%";
blob1.style.top = Math.random() * 50 + 1 + "%";

blob2.style.left = Math.random() * 50 + 1 + "%";
blob2.style.top = Math.random() * 50 + 1 + "%";

blob3.style.left = Math.random() * 50 + 1 + "%";
blob3.style.top = Math.random() * 50 + 1 + "%";
...
blob1.style.width = Math.random() * 300 + 100 + "px";
blob1.style.height = Math.random() * 500 + 150 + "px";

blob2.style.width = Math.random() * 200 + 100 + "px";
blob2.style.height = Math.random() * 500 + 150 + "px";


blob3.style.width = Math.random() * 300 + 100 + "px";
blob3.style.height = Math.random() * 500 + 150 + "px";
